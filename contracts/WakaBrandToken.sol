...
contract WakaBrandToken is IERC20, Ownable {
    ...
    function buyToken(address recipient, uint256 quantity) public payable {
        uint256 amountToTransfer;
        require(recipient != address(0));
        //this.getOwner();

        amountToTransfer = tokenPrice * quantity;
        payable(msg.sender).transfer(amountToTransfer);

        // _transfer token to buyer from owner
        _transfer(this.getOwner(), recipient, quantity);
    }
}
